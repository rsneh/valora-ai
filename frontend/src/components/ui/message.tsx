...
const Message: React.FC<MessageProps> = ({ type, title, message, onClose, className = '' }) => {
  ...
  const typeStyles = {
    success: {
      ...
      icon: <CheckCircleIcon className="h-5 w-5 me-3 flex-shrink-0" />,
    ...
    error: {
      ...
      icon: <XCircleIcon className="h-5 w-5 me-3 flex-shrink-0" />,
    ...
    info: {
      ...
      icon: <InfoIcon className="h-5 w-5 me-3 flex-shrink-0" />,
    ...
    warning: {
      ...
      icon: <InfoIcon className="h-5 w-5 me-3 flex-shrink-0" />, // Or a specific warning icon
